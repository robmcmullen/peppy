...
extra_properties={u'68k Assembly': [],
 ...
 u'SQL': [('fold', '1')],
 u'Scheme': [('fold', '1')],
 u'SimCube': [('fold', '1'), ('fold.comment', '1'), ('fold.compact', '0')],
 u'Smalltalk': [],
 u'Squirrel': [('fold', '1')],
...
keywords={u'68k Assembly': [(0,
 ...
 u'SimCube': [(0,
               'samples lines bands datatype output_scale load input_scale background square output')],
 u'Smalltalk': [(0,
