...
class FundamentalMode(FoldExplorerMixin, EditraSTCMixin,
    ...
    default_classprefs = (
        ...
        BoolParam('case_sensitive_search', True, 'Case of search string must match exactly if True; otherwise mixed case requires exact match and lower case matches all', local=True),
