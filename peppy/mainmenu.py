...
class MainMenu(Component):
    ...
    default_menu=((None,Menu("File").first()),
                  ...
                  (None,Menu("Format").after("Edit").first()),
                  (None,Menu("View").before("Major Mode")),
                  ("View",Separator("modes")),
                  ("View",MenuItem(SidebarShow)),
                  ("View",Separator("menusep")),
                  ("View",Separator("end").last()),
                  (None,Menu("Buffers").before("Major Mode").after("View")),
                  ("Buffers",MenuItem(BufferList).first()),
                  (None,Menu("Major Mode").hide()),
                  (None,Menu("Minor Mode").hide().after("Major Mode")),
                  (None,Menu("Window").last()),
                  ("Window",MenuItem(NewTab).first()),
                  ("Window",Separator("tabs").first()),
                  ("Window",MenuItem(NewFrame).first()),
                  ("Window",MenuItem(DeleteFrame).first()),
                  ("Window",Separator("lastsep").first()),
                  ("Window",MenuItem(FrameList).last()),
                  (None,Menu("&Help").last().after("Window")),
                  )
