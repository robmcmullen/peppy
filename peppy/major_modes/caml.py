...
"""Caml programming language editing support.

Major mode for editing Caml files.
...
class CamlMode(FundamentalMode):
    """Stub major mode for editing Caml files.
...
class CamlModePlugin(IPeppyPlugin):
    """Plugin to register modes and user interface for Caml
    """
