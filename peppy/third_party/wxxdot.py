...
#
# Note: This requires cairo, pango, and pangocairo from the pygtk package.
# On windows, libcairo, libpango, and libpangocairo are available from
# http://www.gtk.org/download/win32.php and wxcairo is available from
# http://wxpython.org/cairo/, but I'm not sure how to get or build the python
# modules for cairo, pango, or pangocairo
#
# Note 2: wxpython (at least up to 2.8.12.1) is broken wrt cairo 1.10.  Had to
# apply the patch found here: https://bugs.archlinux.org/task/26770
#
########## BEGIN PATCH python2-cairo-1.10.patch
#--- wxPython-src-2.8.12.1/wxPython/wx/lib/wxcairo.py
#+++ wxPython-src-2.8.12.1/wxPython/wx/lib/wxcairo.py
#@@ -401,6 +401,48 @@
#                                                       ctypes.py_object)),
...
# def _loadPycairoAPI():
#     global pycairoAPI
########### END PATCH python2-cairo-1.10.patch
#
# On my system, this meant:
# cd /usr/lib64/python2.6/site-packages/wx-2.8-gtk2-unicode/wx/lib
# patch -p4 < python2-cairo-1.10.patch 
#
#
