...
'Background': 'Fundo',
'Bad input': 'Erro de introdu\xc3\xa7\xc3\xa3o',
...
'Display and edit key bindings': 'Visualizar e editar todas as liga\xc3\xa7\xc3\xb5es de teclas',
...
'Invalid range': 'intervalo inv\xc3\xa1lido',
...
'Move the focus to the tab left of the current tab': 'Mover o foco para a tabula\xc3\xa7\xc3\xa3o da esquerda no tabulador activo',
'Move the focus to the tab right of the current tab': 'Mover o foco para a tabula\xc3\xa7\xc3\xa3o da direita no tabulador activo',
...
'Search backwards for a string in the text': 'Procurar para tr\xc3\xa1s express\xc3\xa3o no texto',
'Search for a python regular expression': 'Procurar por uma express\xc3\xa3o regular Python',
'Search for a string in the text': 'Procurar por uma express\xc3\xa3o no texto',
'Search string was not found': 'A palavra n\xc3\xa3o foi encontrada',
'Search using shell-style wildcards': 'Procurar utilizando coringas de shell',
'Seek %s': 'Procurar %s',
...
'The system returned the following message when attempting to move/copy %(filename)s: %(errmsg)s': 'O sistema devolveu a seguinte mensagem: %(errmsg)s quando tentava copiar/mover %(filename)s',
...
'You can not execute source control commands across multiple repositories': 'N\xc3\xa3o pode executar comando de controle de fontes utilizando reposit\xc3\xb3rios diferentes',
